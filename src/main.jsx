      ...
      <div className='twoScrean'>
        <div className='BG2'>
          <div>
            ...
            <h3>В нашем магазине туристического снаряжения вы найдете все необходимое для активного отдыха на природе. Мы <br></br>гордимся качеством своих товаров, которые соответствуют высоким стандартам. У нас есть все, что нужно для <br></br>комфортного и безопасного отдыха на свежем воздухе.</h3>
          </div>
          <div className='catalog'>
            <div className='tov1'>
              <div className='text-tovB'>Одежда</div>
              <div className='text-tov'>адаптированная под различные погодные условия - от солнечной жары до холодного ветра и дождя</div>
            </div>
            <div className='tov2'>
              <div className='text-tovB'>Рюкзаки</div>
              <div className='text-tov'>разной вместимости и конструкции, подходящие для длительных походов и кратких прогулок</div>
            </div>
            <div className='tov3'>
